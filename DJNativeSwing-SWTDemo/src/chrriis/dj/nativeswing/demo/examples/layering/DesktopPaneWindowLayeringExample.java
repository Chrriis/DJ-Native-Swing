 ...
 */
public class DesktopPaneWindowLayeringExample extends JPanel {

  public DesktopPaneWindowLayeringExample() {
    super(new BorderLayout(0, 0));
    NativeComponentEmbedder.setPreferredLayering(NativeComponentEmbedder.Layering.WINDOW_LAYERING);
